...
function Table({
    ...
    const handleDeleteWorker = (id, email) => {
        axios.delete(`/workers?id=${id}&&email=${email}`).then((res) => {
    ...
    const handleDeleteService = (id) => {
        axios.delete(`/services?id=${id}`).then((res) => {
    ...
    const handleApproveApplication = (worker) => {
        axios.put('/application', worker).then((res) => {
            setApplicationUpdate(true);
        });
    };
    // handle delete application
    const handleDeleteApplication = (email) => {
        axios.delete(`/application?email=${email}`).then((res) => {
    ...
    const handleWorkingStatus = (email, status, id) => {
        axios.put('/workingStatus', { email, status, id }).then((res) => {
    ...
    const handleDeleteToLet = (id) => {
        axios.delete(`/toLet/delete?id=${id}`).then((res) => {
